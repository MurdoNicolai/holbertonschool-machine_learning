...
def availableShips(passengerCount):
    ...
    if passengerCount == 1:
        return ['AA-9 Coruscant freighter', 'CR90 corvette',
                ...
                'Executor', 'Imperial shuttle',
                'J-type diplomatic barge', 'Millennium Falcon',
                'Rebel transport', 'Republic Assault ship',
                'Republic Cruiser', 'Republic attack cruiser', 'Scimitar',
                'Sentinel-class landing craft', 'Slave 1', 'Solar Sailer',
                'Theta-class T-2c shuttle', 'Trade Federation cruiser']
